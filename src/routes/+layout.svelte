...
<div class="min-h-[100vh] p-5 text-slate-200 lg:max-w-[680px] lg:mx-auto">
	...
	<header class="mt-8">
		<h1 class="text-4xl font-bold font-serif">Hello Folks!</h1>
		<nav class="mt-3" aria-label="Main website navigation">
			<ul class="flex gap-5">
				<li>
					<a href="/" class="underline decoration-purple-400 underline-offset-2">Home</a>
				</li>
				<li>
	...
	<footer>
		<p class="text-center mt-8">
			Made with 💜 and <a
				...
				rel="nofollow"
				class="underline decoration-purple-400 underline-offset-2"
